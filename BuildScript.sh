...
docker build -t ghcr.io/bigpod98/rmn-aptrepoinit:latest -f Dockerfile/Scripts/APTRepoInit/Dockerfile . --no-cache
docker build -t ghcr.io/bigpod98/rmn-rpmrepoinit:latest -f Dockerfile/Scripts/RPMRepoInit/Dockerfile . --no-cache
docker build -t ghcr.io/bigpod98/rmn-pacmanrepoinit:latest -f Dockerfile/Scripts/PacmanRepoInit/Dockerfile . --no-cache
